...
mat4 PerspectiveProjectionMatrix = perspective(radians(90.0f), 800.0f /  600.0f, 0.1f, 100.0f);
mat4 OrhoProjectionMatrix = ortho(-130.0f, 130.0f, -130.0f, 130.0f, 0.1f, 100.0f);

mat4 ViewModelMatrix = glm::lookAt(glm::vec3(35, 35, 4), glm::vec3(0, 0, 0), glm::vec3(0,1,0));
mat4 ViewLightMatrix = glm::lookAt(glm::vec3(65, 75, -10), glm::vec3(0, 0, 0), glm::vec3(0,1,0));
...
int main()
{
    try {
        ...
        Framebuffer<TexelFormat::RGB16_F,WritePixels::RenderBuffer, WritePixels::NoWrite> resultFrameBuffer(1000, 1000);
//        Framebuffer<TexelFormat::RGB16_F, WritePixels::Texture, WritePixels::NoWrite> depthFrameBuffer(1000, 1000);
